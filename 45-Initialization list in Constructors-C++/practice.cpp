...
class Sports : virtual public Student{
    ...
    public:
        ...
        Sports(float s){
            score = s;
            cout << "Sports Constructor is called." << endl;
        }
...
class Result : public Test, public Sports{
    ...
    public:
        Result(){};
        Result(int a, float b, float c, float d, int e, int f) : Student(a), Test(b, c), Sports(d), num1(e), num2(f){     // here "e" and "f" are the arguments of "Result" constructor. num1 and num2 are initialized by initialization list
